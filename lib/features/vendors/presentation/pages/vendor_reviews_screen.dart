...
/// Shared AsyncValue handling for the two review views below.
Widget reviewsAsyncView(
  BuildContext context,
  AsyncValue<List<VendorReview>> reviews,
  Widget Function(List<VendorReview> allReviews) onData,
) {
  return reviews.when(
    ...
    error: (e, _) => const VendorReviewsEmptyState(),
    data: onData,
  );
}
...
class _VendorReviewsSectionState extends ConsumerState<VendorReviewsSection> {
  ...
  Widget build(BuildContext context) {
    final reviewsAsync = widget.vendorId != null
        ? ref.watch(vendorReviewsFamilyProvider(widget.vendorId!))
        : ref.watch(vendorReviewsProvider);

    return reviewsAsyncView(context, reviewsAsync, (allReviews) {
...
class _VendorReviewsScreenState extends ConsumerState<VendorReviewsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: reviewsAsyncView(context, reviewsAsync, (allReviews) {
        final filtered = filterReviews(allReviews, _filter);
